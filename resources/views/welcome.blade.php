            ...
            <!DOCTYPE html>
                ...
                <!-- Bootstrap CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/bootstrap.min.css')}}">
                <!-- Site CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/style.css')}}">
                <!-- Colors CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/colors.css')}}">
                <!-- ALL VERSION CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/versions.css')}}">
                <!-- Responsive CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/responsive.css')}}">
                <!-- Custom CSS -->
                <link rel="stylesheet" href="{{asset('sport/css/custom.css')}}">
                <!-- font family -->
                <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
                <!-- end font family -->
                <link rel="stylesheet" href="{{asset('sport/css/3dslider.css')}}" />
                <script src="{{('sport/http://code.jquery.com/jquery-1.11.1.min.js')}}"></script>
                <link href="{{('sport/http://www.jqueryscript.net/css/jquerysctipttop.css')}}" rel="stylesheet" type="text/css">
                <script src="{{asset('sport/js/3dslider.js')}}"></script>
                </head>
                <body class="game_info" data-spy="scroll" data-target=".header">
                <!-- LOADER -->
                <div id="preloader">
                    <img class="preloader" src="{{asset('sport/images/loading-img.gif')}}" alt="">
                </div>
                <!-- END LOADER -->
                <section id="top">
                    <header>
                            ...
                            <div class="header-top">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="full">
                                            <div class="logo">
                                                <a href="index.html"><img src="{{asset('sport/images/logo.png')}}" alt="#" /></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="right_top_section">
                                            ...
                                            <ul class="login">
                                                ...
                                                <li>  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                                                        @if (Route::has('login'))
                                                                                ...
                                                                                <div id="menCollection" class="carousel slide" data-ride="carousel">
                                                                                    <div class="carousel-inner">
                                                                                        <div class="item active">
                                                                                            <div class="banner-for-match"><a href="#"><img class="img-responsive" src="{{asset('sport/images/match-banner1.jpg')}}" alt="#" /></a></div>
                                                                                        </div>
                                                                                        <!-- End Item -->
                                                                                        <div class="item">
                                                                                            <div class="banner-for-match"><a href="#"><img class="img-responsive" src="{{asset('sport/images/match-banner1.jpg')}}" alt="#" /></a></div>
                                ...
                                <div class="matchs-vs">
                                    <div class="vs-team">
                                        <div class="team-btw-match">
                                            <ul>
                                                <li>
                                                    <img src="{{asset('sport/images/img-03.png')}}" alt="">
                                                    <span>Footbal Team</span>
                                                </li>
                                                <li class="vs"><span>vs</span></li>
                                                <li>
                                                    <img src="{{asset('sport/images/img-04.png')}}" alt="">
                            ...
                            <div class="col-lg-4 col-sm-4 col-xs-12">
                                <aside id="sidebar" class="left-bar">
                                    <div class="banner-sidebar">
                                        <img class="img-responsive" src="{{asset('sport/images/img-05.jpg')}}" alt="#" />
                                ...
                                <aside id="sidebar" class="left-bar">
                                    <div class="feature-matchs">
                                        <div class="team-btw-match">
                                            <ul>
                                                <li>
                                                    <img src="{{asset('sport/images/img-01_002.png')}}" alt="">
                                                    <span>Portugal</span>
                                                </li>
                                                <li class="vs"><span>vs</span></li>
                                                <li>
                                                    <img src="{{asset('sport/images/img-02.png')}}" alt="">
                                                    <span>Germany</span>
                                                </li>
                                            </ul>
                                            <ul>
                                                <li>
                                                    <img src="{{asset('sport/images/img-03_002.png')}}" alt="">
                                                    <span>Portugal</span>
                                                </li>
                                                <li class="vs"><span>vs</span></li>
                                                <li>
                                                    <img src="{{asset('sport/images/img-04_003.png')}}" alt="">
                                                    <span>Germany</span>
                                                </li>
                                            </ul>
                                            <ul>
                                                <li>
                                                    <img src="{{asset('sport/images/img-05_002.png')}}" alt="">
                                                    <span>Portugal</span>
                                                </li>
                                                <li class="vs"><span>vs</span></li>
                                                <li>
                                                    <img src="{{asset('sport/images/img-06.png')}}" alt="">
                                                    <span>Germany</span>
                                                </li>
                                            </ul>
                                            <ul>
                                                <li>
                                                    <img src="{{asset('sport/images/img-07_002.png')}}" alt="">
                                                    <span>Portugal</span>
                                                </li>
                                                <li class="vs"><span>vs</span></li>
                                                <li>
                                                    <img src="{{asset('sport/images/img-08.png')}}" alt="">
                                                    <span>Germany</span>
                                                </li>
                                            </ul>
                                            <ul>
                                ...
                                <aside id="sidebar" class="left-bar">
                                    <div class="feature-matchs">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td><img src="{{asset('sport/images/img-01_004.png')}}" alt="">Liverpool</td>
                                                <td>10</td>
                                                <td>12</td>
                                                <td>20</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td><img src="{{asset('sport/images/img-02_002.png')}}" alt="">Chelsea</td>
                                                <td>10</td>
                                                <td>12</td>
                                                <td>20</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td><img src="{{asset('sport/images/img-03_003.png')}}" alt="">Norwich City</td>
                                                <td>20</td>
                                                <td>15</td>
                                                <td>20</td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td><img src="{{asset('sport/images/img-04_002.png')}}" alt="">West Brom</td>
                                                <td>60</td>
                                                <td>10</td>
                                                <td>60</td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td><img src="{{asset('sport/images/img-05.png')}}" alt="">sunderland</td>
                                                <td>30</td>
                                                <td>06</td>
                                                <td>30</td>
                                            </tr>
                            ...
                            <div class="col-lg-8 col-sm-8 col-xs-12">
                                <div class="news-post-holder">
                                    <div class="news-post-widget">
                                        <img class="img-responsive" src="{{asset('sport/images/img-01_002.jpg')}}" alt="">
                                    ...
                                    <div class="news-post-widget">
                                        <img class="img-responsive" src="{{asset('sport/images/img-02_003.jpg')}}" alt="">
                                        <div class="news-post-detail">
                                            <span class="date">20 march 2016</span>
                                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                                ...
                                <div class="news-post-holder">
                                    <div class="news-post-widget">
                                        <img class="img-responsive" src="{{asset('sport/images/img-03_003.jpg')}}" alt="">
                                        <div class="news-post-detail">
                                            <span class="date">20 march 2016</span>
                                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                            ...
                            <div class="col-md-12">
                                <div class="full">
                                    <div class="match_vedio">
                                        <img class="img-responsive" src="{{asset('sport/images/img-07.jpg')}}" alt="#" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="col-md-3">
                                    <div class="team-column style-2">
                                        <img src="{{asset('sport/images/img-1-1.jpg')}}" alt="">
                                        ...
                                        <div class="overlay">
                                            <div class="team-detail-hover position-center-x">
                                                ...
                                                <a class="btn blue-btn" href=" {{asset('sport/soccer/team-detail.html')}}" tabindex="0">View Detail</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="team-column style-2">
                                        <img src="{{asset('sport/images/img-1-2.jpg')}}" alt="">
                                        <div class="player-name">
                                            <div class="desination-2">Defender</div>
                                            <h5>Charles Wheeler</h5>
                                            <span class="player-number">12</span>
                                ...
                                <div class="col-md-3">
                                    <div class="team-column style-2">
                                        <img src="{{asset('sport/images/img-1-3.jpg')}}" alt="">
                                        <div class="player-name">
                                            <div class="desination-2">Defender</div>
                                            <h5>Charles Wheeler</h5>
                                            <span class="player-number">12</span>
                                ...
                                <div class="col-md-3">
                                    <div class="team-column style-2">
                                        <img src="{{asset('sport/images/img-1-4.jpg')}}" alt="">
                                        <div class="player-name">
                                            <div class="desination-2">Defender</div>
                                            <h5>Charles Wheeler</h5>
                                            <span class="player-number">12</span>
                ...
                <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            @auth
                                <a  style="color: red" href="{{ url('/dashboard') }}" class="text-sm text-gray-700 underline">Dashboard</a>
                            @else
                                <a  style="color: red" href="{{ route('login') }}" class="text-sm text-gray-700 underline">Log in</a>
                                    ...
                                    <div class="full">
                                        <div class="footer-widget">
                                            <div class="footer-logo">
                                                <a href="#"><img src="{{asset('sport/images/footer-logo.png')}}" alt="#" /></a>
                                            </div>
                    ...
                    <!-- ALL JS FILES -->
                    <script src="{{asset('sport/js/all.js')}}"></script>
                    <!-- ALL PLUGINS -->
                    <script src="{{asset('sport/js/custom.js')}}"></script>
                </body>
                </html>
